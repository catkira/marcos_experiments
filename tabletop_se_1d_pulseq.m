...
delayTE2 = ceil((TE - (mr.calcDuration(rf90)  - rf90.delay)/2 ...
    - delayTE1 - mr.calcDuration(gxPre) - mr.calcDuration(rf180) ...
    - gx.delay - 0.0006)/seq.gradRasterTime)*seq.gradRasterTime;
